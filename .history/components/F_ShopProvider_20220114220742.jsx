...
const F_ShopProvider = (props) => {
    ...
    const closeCart = () => { setState({ isCartOpen: true }) }
    const openCart = () => { setState({ isCartOpen: false }) }
    const closeMenu = () => { setState({ isCartOpen: false }) }
    const openMenu = () => { setState({ isCartOpen: true }) }
