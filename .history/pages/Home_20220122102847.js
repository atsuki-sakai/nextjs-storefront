            ...
            <div className='tw-grid tw-grid-cols-3 tw-gap-4 tw-place-items-center tw-m-8'>
                {
                    products.map(product => (
                        <div className=' tw-bg-gray-300 tw-static'>
                            <Link href={`/products/${product.handle}`}>
                                <a>
                                    <Image className='tw-flex tw-justify-center' src={product.variants[0].image.src} width={220} height={220} alt={product.title} />
                                </a>
                            </Link>
